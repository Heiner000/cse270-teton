...
class TestSmokeTest:
    ...
    def test_adminPage(self):
        ...
        self.driver.set_window_size(912, 881)
        self.driver.find_element(By.ID, "username").click()
        self.driver.find_element(By.ID, "username").send_keys("test")
        self.driver.find_element(By.ID, "password").click()
        self.driver.find_element(By.ID, "password").send_keys("tester")
    ...
    def test_homePage(self):
        ...
        self.driver.set_window_size(1318, 880)
    ...
    def test_joinPage(self):
        ...
        self.driver.find_element(By.NAME, "fname").click()
        self.driver.find_element(By.NAME, "fname").send_keys("garrett")
        self.driver.find_element(By.NAME, "lname").send_keys("heiner")
        self.driver.find_element(By.NAME, "bizname").send_keys("western water")
